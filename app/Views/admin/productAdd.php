              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="POST" enctype="multipart/form-data"
                    action="<?= base_url().'/admins/' ?>product/add">
                    <div class="form-group">
                      ...
                      <?php
                        if(@$errors["name"]) {
                          echo '<p class="text-danger pt-2">'.$errors["name"].'</p>';
                        }
                      ?>
                    </div>
                    <div class="form-group">
                      ...
                      <?php
                        if(@$errors["price"]) {
                          echo '<p class="text-danger pt-2">'.$errors["price"].'</p>';
                        }
                      ?>
                    </div>
                    <div class="form-group">
                      ...
                      <?php
                        if(@$errors["qty"]) {
                          echo '<p class="text-danger pt-2">'.$errors["qty"].'</p>';
                        }
                      ?>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <?php
                        if(@$errors["image"]) {
                          echo '<p class="text-danger pt-2">'.$errors["image"].'</p>';
                        }
                      ?>
                    </div>
                    <div class="form-group">
                      ...
                      <?php
                        if(@$errors["categories_id"]) {
                          echo '<p class="text-danger pt-2">'.$errors["categories_id"].'</p>';
                        }
                      ?>
                    </div>
                    <div class="form-group">
                      ...
                      <?php
                        if(@$errors["des"]) {
                          echo '<p class="text-danger pt-2">'.$errors["des"].'</p>';
                        }
                      ?>
                    </div>
