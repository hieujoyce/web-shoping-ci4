...
<body>
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <a href="<?= base_url().'/admins/' ?>user/add" class="btn btn-primary">Add</a>
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?= $user['role'] ?></td>
                          <td class="py-1">
                            <?= $user['avatar'] ? '<img src="'.base_url().$user['avatar'].'" />' : 'Chưa cập nhật' ?>
                          </td>
                          <td>
                            ...
                            <a type="button" class="btn btn-warning btn-sm"
                              href="<?= base_url().'/admins/user/edit/'.$user['id'] ?>">
                              Edit
                            </a>
                          </td>
                        </tr>
  ...
  function deleteUser(id) {
    let bool = confirm('Are you sure you want to delete this user?');
    if (bool) {
      window.location.href = "<?= base_url() ?>/admins/user/delete/" + id;
    }
  }
  </script>
</body>
