              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="POST" enctype="multipart/form-data"
                    action="<?= base_url().'/admins/' ?>user/add">
                    ...
                    <div class="form-group">
                      ...
                      <input type="password" class="form-control" placeholder="Password" name="password_cf"
                    ...
                    <div class="form-group">
                      ...
                      <?php
                        if(@$errors["avatar"]) {
                          echo '<p class="text-danger pt-2">'.$errors["avatar"].'</p>';
                        }
                      ?>
                    </div>
