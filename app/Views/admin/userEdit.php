    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="/pages/tables/user.html">
          ...
          <li class="nav-item">
            <a class="nav-link" href="/pages/tables/category.html">
              <i class="icon-grid menu-icon"></i>
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="POST" action="<?= base_url().'/admins/user/edit/'.$user["id"] ?>">
                    ...
                    <div class="form-group">
                      <label for="exampleInputPassword5">Password Verify</label>
                      <input type="password" class="form-control" name="password_cf" placeholder="Password"
