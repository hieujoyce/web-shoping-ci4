...
<body>
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <a href="<?= base_url().'/admins/' ?>product/add" class="btn btn-primary">Add</a>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <a type="button" class="btn btn-warning btn-sm"
                              href="<?= base_url().'/admins/product/edit/'.$product['id'] ?>">
                              Edit
                            </a>
                          </td>
                        </tr>
  ...
  function deleteProduct(id) {
    let bool = confirm('Are you sure you want to delete this product?');
    if (bool) {
      window.location.href = "<?= base_url() ?>/admins/product/delete/" + id;
    }
  }
  </script>
</body>
