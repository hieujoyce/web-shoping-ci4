...
<body>
          ...
          <div class="row">
            <div class="col-lg-8 col-md-6">
              ...
              <div class="checkout__input">
                ...
                <input id="orderItems" type="hidden" name="orderItems">
              </div>
              <div class="row">
                <div class="col-lg-6">
                  <div class="checkout__input">
            ...
            <div class="col-lg-4 col-md-6">
              <div class="checkout__order">
                ...
                <button type="submit" class="site-btn"
                  onclick="localStorage.setItem('myCart', JSON.stringify([]));">PLACE
                  ORDER</button>
              </div>
            </div>
          </div>
  ...
  <script>
  document.querySelector("#orderItems").value = localStorage.getItem(keyCart) || "[]";
  </script>
</body>
