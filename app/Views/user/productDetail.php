            ...
            <ul class="nav nav-tabs" role="tablist">
              <li class="nav-item">
                <a class="nav-link active" data-toggle="tab" href="#tabs-1" role="tab">
                  <div class="product__thumb__pic set-bg" data-setbg="<?= base_url().$product['image'] ?>">
                  </div>
                </a>
              </li>
            </ul>
        ...
        <div class="row d-flex justify-content-center">
          <div class="col-lg-8">
            <div class="product__details__text">
              ...
              <h3>$<?= $product['price'] ?> <span>$<?= round($product['price'] * 1.2, 2 ) ?></span></h3>
              <p><?= $product['des'] ?></p>
              ...
              <div class="product__details__cart__option">
                <div class="quantity">
                  <div class="pro-qty">
                    <input id="2qty" type="text" value="1">
                  </div>
                </div>
                <button class="primary-btn"
                  onclick="addItemCart(<?= $product['id'].',\''.$product['name'].'\',1,'.$product['price'].',\''.base_url().$product['image'].'\''?>)">add
                  to cart</button>
              </div>
              ...
              <div class="product__details__last__option">
                ...
                <ul>
                  ...
                  <li><span>Categories:</span> <?= $product['categories_name'] ?></li>
