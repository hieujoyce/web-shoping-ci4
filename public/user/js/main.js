...
(function ($) {
  ...
  // proQty.prepend(
  //   `<span class="fa fa-angle-left dec qtybtn" onclick="subCountItemCart('${dataId}')"></span>`
  // );
  // proQty.append(
  //   `<span class="fa fa-angle-right inc qtybtn" onclick="addCountItemCart('${dataId}')"></span>`
  // );
  proQty.on("click", ".qtybtn", function () {
    var $button = $(this);
    var oldValue = $button.parent().find("input").val();
